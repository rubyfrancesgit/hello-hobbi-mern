...
function CreateSession() {
  ...
  return (
    <div className="create-session">
      ...
      <form action="">
        <div className="create-session__form-container">
            ...
            <div className="create-session__photo-upload-container">
                ...
                <input className="create-session__img-upload-btn" id="sessionPicTwo" type="file" accept="image/jpg, image/png,image/jpeg" />
            </div>
