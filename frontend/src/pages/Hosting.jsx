                    ...
                    <div className="hosting">
                        ...
                        <form className="hosting__form" action="#">
                            <div className="hosting__div">
                                ...
                                <label className="hosting__p" for="hostingCheckbox1"><b>Experience</b> - you don’t need to be an expert by any means! But you’ve got to know your way around the hobby you teach - at least enough to show a beginner.</label>
                            </div>
                            ...
                            <div className="hosting__div">
                                ...
                                <label className="hosting__p" for="hostingCheckbox1"><b>Equipment</b> - if you’re teaching a hobby that requires equipment or materials, you’ll need this for the session. Plan out any equipment you need ahead of time.</label>
                            </div>
                            ...
                            <div className="hosting__div">
                                ...
                                <label className="hosting__p" for="hostingCheckbox1"><b>Teaching</b> - Hobbi is all about learning new skills, so you’ll have to be comfortable teaching people. If you don’t have official teaching experience, no worries! You can always start by teaching a friend first.</label>
                            </div>
                        </form>
